...
- W8 判定ダンプ（U3・U5 確定用、最優先）：`log/pico-bcon-w8-epoch.uf2` を flash し、通常ペア→open（host 保存）→約 2 秒後 WDT 死を 1 回再現し、次 boot の `w8epoch`〜`w8ev` 行一式を回収する (`docs/history/2026-09-15-wdt/hw-batch-2026-09-15.md:11-17`)
