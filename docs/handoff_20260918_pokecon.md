# pico-bcon → PokeCon Modified セッション引継ぎ（2026-09-18）
...
- 焼き済みFW：baudhunt無線版（`log/pico-bcon-baudhunt-wireless-1M-2a3057c.uf2`、SHA `58a1efa3…`）。`baud=0L`（115200 lock）、セッション生存を確認済み。
